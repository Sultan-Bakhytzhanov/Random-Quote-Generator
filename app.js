//? Функция генерирующая случайную цитату
function gen() {
	//* Библиотека цитат
	const quotes = {
		'- Walt Disney':
	...
	//* Метод Object.keys возвращает массив ключей обьекта "quotes" и записывает в переменную "authors"
	let authors = Object.keys(quotes);

	//? Метод Math.random генерирует случайное дробное число от 0 до 1
	//? После это случайное дробное число умножается на длину массива "authors"
	//? И все это округляется (в меньшую сторону) методом Math.floor
